...
`cloud-itonami-isco-9624` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real worker, site or operator data, credentials or operating
  documents.
- Keep production writes and disclosures behind WaterFirewoodGovernor.
...
- Never widen the closed op-allowlist to include a collection-work-
  execution op, a site-safety-clearance op (e.g. one that would declare
  a water source safe for collection), or a site-safety-supervisor-
