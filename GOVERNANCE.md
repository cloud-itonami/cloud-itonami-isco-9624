...
`cloud-itonami-isco-9624` is an OSS open-occupation blueprint. Governance covers
...
- WaterFirewoodGovernor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- a collection-work-execution decision, a site-safety-clearance
  decision (e.g. declaring a water source safe for collection), and any
  override of a site safety supervisor's judgment, stay permanently
...
- attempting to route a collection-work-execution decision, a site-
